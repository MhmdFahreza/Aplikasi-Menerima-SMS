...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private lateinit var requestPermissionLauncher: ActivityResultLauncher<String>  // Declare the requestPermissionLauncher
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requestPermissionLauncher = registerForActivityResult(  // Initialize it in onCreate
